...
<html>
  <body>
    ...
    <p>Best regards,<br/>NLF Database System</p>
        ...
        print(f"\n⏳ Creating SMTP connection to {config.SMTP_SERVER}:{config.SMTP_PORT}...")
        ...
        server.sendmail(config.SMTP_FROM_EMAIL, recipient, message.as_string())
        ...
        print(f"   Email sent from {config.SMTP_FROM_EMAIL} to {recipient}")
        return True
